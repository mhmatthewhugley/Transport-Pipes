...
public class FakeBlock_1_17 extends FakeBlock implements Block {

    public FakeBlock_1_17(World world, Location location) {
        this.world = world;
        this.location = location;
        this.material = Material.HOPPER;
        this.blockData = this.material.createBlockData();
        this.hopper = new FakeHopper_1_17(world, location, this);
    }
