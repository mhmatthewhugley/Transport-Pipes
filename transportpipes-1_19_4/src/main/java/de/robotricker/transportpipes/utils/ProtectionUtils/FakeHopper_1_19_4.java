...
public class FakeHopper_1_19_4 implements Hopper {
    ...
    public FakeHopper_1_19_4(World world, Location location, Block block) {
        this.world = world;
        this.location = location;
        this.block = block;
        this.inventory = Bukkit.createInventory(null, InventoryType.HOPPER);
        this.data = CraftMagicNumbers.getBlock(Material.HOPPER).o();
