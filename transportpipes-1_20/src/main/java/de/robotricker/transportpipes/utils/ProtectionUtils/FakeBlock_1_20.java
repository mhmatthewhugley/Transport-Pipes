...
public class FakeBlock_1_20 extends FakeBlock implements Block {

    public FakeBlock_1_20(World world, Location location, Material material) {
        this.world = world;
        this.location = location;
        this.material = Material.HOPPER;
        this.blockData = this.material.createBlockData();
        this.hopper = new FakeHopper_1_20(world, location, this);
    }
    ...
    public String getTranslationKey() {
        return this.material.getTranslationKey();
    }
}
