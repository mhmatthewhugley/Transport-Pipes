...
public class FakeHopper_1_19 implements Hopper {
    ...
    public FakeHopper_1_19(World world, Location location, Block block) {
        this.world = world;
        this.location = location;
        this.block = block;
        this.inventory = Bukkit.createInventory(null, InventoryType.HOPPER);
        this.data = CraftMagicNumbers.getBlock(Material.HOPPER).m();
